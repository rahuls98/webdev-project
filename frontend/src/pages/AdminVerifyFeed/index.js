...
import {getUnverifiedExpertsThunk, verifyExpertThunk} from "../../services/unverified-experts-thunk";
...
const AdminVerifyFeed = () => {
    ...
    const handleVerifyListener = async(id) => {
        ...
        console.log(idVerified)
        setUnverifiedExperts(unverifiedExperts.filter((expert) => expert._id !== idVerified.payload));
    }
                                ...
                                <div>
                                    <div className="TableItemExpert_container">
                                        <div className="TableItemExpert_listitem">
                                            <ListItem
                                                ...
                                                secondaryAction={
                                                    <Button
                                                        variant="outlined"
                                                        size="small"
                                                        onClick = {() => handleVerifyListener(expert._id)}
                                                    >
                                            ...
                                            >
                                                <ListItemAvatar>
                                                    <Avatar>{expert.fullname.toUpperCase()}</Avatar>
                                                </ListItemAvatar>
                                                <ListItemText
                                                    ...
                                                    secondary={(
                                                        <div>
                                                            ...
                                                            <br/>
                                                            <i style={{fontSize: "13px"}}>
                                                                Followers: {expert.followerCount}
                                                            </i>
                                                        </div>
                                                    )}
                                                />
